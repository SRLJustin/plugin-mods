...
public class ZulrahPatternB extends ZulrahPattern
{
	public ZulrahPatternB()
	{
		...
		add(ZulrahLocation.WEST, ZulrahType.RANGE, StandLocation.TOP_WEST, null);
		...
		add(ZulrahLocation.SOUTH, ZulrahType.MAGIC, StandLocation.TOP_WEST, Prayer.PROTECT_FROM_MAGIC);
